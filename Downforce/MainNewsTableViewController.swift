...
//  Downforce
//
//  Created by Ayush Bhople on 20/03/25.
//
...
//        return newsArray[0].articles?.count ?? 10
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (newsArray.count == 0){
            ...
            cell.textLabel?.text = newsArray[0].articles?[indexPath.row].title
        }
...
extension MainNewsTableViewController: MainNewsFetcherDelegate {
